...
# Data files
vocab_question_file = './data/vocabulary_vqa.txt'
vocab_layout_file = './data/vocabulary_layout.txt'
vocab_answer_file = './data/answers_vqa.txt'
...
eval_output_file = './exp_vqa/eval_outputs/%s/%s.%s.txt' % (exp_name, snapshot_name, tst_image_set)
...
def plot_sample(sample_idx):
    ...
    example_layout = predicted_layouts[:,sample_idx] #save predicted_layouts for further usage
