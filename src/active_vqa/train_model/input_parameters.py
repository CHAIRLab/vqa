...
parser.add_argument("--exp_name",type=str, default="vqa_gt_layout")
...
parser.add_argument("--data_dir",type=str,default="./exp_vqa/data")
parser.add_argument("--image_feat_dir",type=str,default="/home/active_vqa/dataset/data/vgg_pool5/train")
parser.add_argument("--out_dir",type=str,default="./exp_vqa")
...
vocab_question_file = os.path.join(data_dir, 'vocabulary_vqa.txt')
vocab_layout_file = os.path.join(data_dir, 'vocabulary_layout.txt')
vocab_answer_file = os.path.join(data_dir, 'answers_vqa.txt')


#imdb_file_trn = './exp_vqa/data/imdb/imdb_trn.npy'
#imdb_file_tst = './exp_vqa/data/imdb/imdb_val.npy'
